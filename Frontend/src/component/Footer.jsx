...
const Footer = () => {
  return (
    <>
      <footer className="bg-gray-800  p-8 flex justify-between text-white text-left gap-8">
        <aside className="text-left">
          <img className="w-14 h-12 rounded" src={image} alt="image" />
          <p className="text-3xl font-bold my-2">Durontotravelsbd</p>
        ...
        <nav>
          <h6 className="text-3xl font-bold text-white">Contact</h6>
          ...
          <p className="text-3xl font-bold text-white">Email address</p>
          <p className="link link-hover text-base font-medium  my-3">
            durontotravelsbd@gmail.com
          </p>
          <p className="text-3xl font-bold text-white">Phone Number</p>
          <p className="link link-hover text-base font-medium my-3">
