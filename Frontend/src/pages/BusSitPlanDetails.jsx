      ...
      <div className="mt-6 bg-white shadow-md rounded-lg p-6">
        ...
        <div className="border border-gray-300 rounded-lg p-4 flex items-center justify-between gap-5">
          ...
          <div className="md:w-[25%]">
            <p className="text-gray-700">📍 {locations[0]?.label} (7:30 am)</p>
            <p className="text-gray-700">📍 {locations[1]?.label} (9:30 am)</p>
        ...
        {showSeatPlan && (
          <div className="mt-6 flex gap-6">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md w-1/3">
              <h2 className="text-xl font-bold mb-4 text-green-600 text-center">
                Selected Seats
              </h2>
              {selectedSeats.length > 0 ? (
                ...
                <p className="text-gray-700 text-center">No seats selected.</p>
              )}
